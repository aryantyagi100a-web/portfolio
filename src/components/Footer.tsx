        ...
        <div className="mb-14 sm:mb-20">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-6 border-b border-line">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight lowercase text-paper">
                ...
                <div key={idx} className="py-4 sm:py-5">
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                      ...
                      <span className="text-sm sm:text-base font-semibold lowercase text-paper group-hover:text-white transition-colors">
                        {faq.question}
                      </span>
                    </div>
                    <div
